...
<body>
    <header>
        <img src="../src/assets/img/telefoot-color-bg-01.svg" alt="Telefoot - La chaine du foot" />
        <nav>
            <ul>
                <li>Home</li>
                <li>Telefoot Bar</li>
    ...
    <main>
        <section class="hero">
            <img src="../src/assets/img/hero-01.7204aef.jpg" alt="">
        </section>

        <section class="tv-rights">
            <div class="tv-rights-logo">
                <img src="../src/assets/img/ligue1.c3911c3.png" alt="Ligue 1 Uber Eats" />
                <img src="../src/assets/img/ligue2.58a26b7.png" alt="Ligue 2 BKT" />
                <div class="europe-wrapper">
                    <div class="europe-wrapper-image">
                        <img src="../src/assets/img/champions-league-v-w.a905df8.svg" alt="Ligue des Champions" />
                        <img src="../src/assets/img/europa-league-v-w.f4fdaf6.svg" alt="Ligue Europa" />
                    </div>
                    <div class="europe-wrapper-text">
                        Saison 2020-2021
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row offers">
                    <div class="item offer">
                        <div class="header">
                            <img src="../src/assets/img/telefoot-mono-white.svg" alt="">
                    ...
                    <div class="item offer">
                        <div class="header">
                            <img src="../src/assets/img/telefoot-color-bg-01.svg" alt="">
                        </div>
                        <div class="price">
                    ...
                    <div class="item offer">
                        <div class="header">
                            <img src="../src/assets/img/logo-netflix.6dbba45.svg" alt="">
                            <span>+</span>
                            <img src="../src/assets/img/telefoot-color-bg-01.svg" alt="">
                        </div>
                        <div class="price">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="item">
                        <h4>Opérateurs TV</h4>
                        <div class="icons">
                            <img src="../src/assets/img/logo-sfr.ee2a768.svg" alt="">
                            <img src="../src/assets/img/bouygues.a12732e.png" alt="">
                        </div>
        ...
        <section id="telefoot-bar">
            <div class="container">
                <img src="../src/assets/img/telefoot-bar-color-bg.svg" alt="Telefoot Bar">
